...
about:
  links:
    ...
    - text: "{{< fa arrow-up-right-from-square >}} Article (journal)"
...
**2)** Assist in analyzing the data and writing a [scientific paper](/content/pubs/ICCHP20/) presenting the project.

...
![](TactiBelt-v2.jpg "Photography of the second iteration of the TactiBelt"){fig-alt="Photography of the second iteration of the TactiBelt"}

**3)** Lead the design and development of the project's experimental platform. The platform uses Unity, connects to various motion tracking devices (Polhemus, VICON, pozyx), uses [PureData](https://puredata.info/) for sound-wave generation, and [Steam Audio](https://valvesoftware.github.io/steam-audio/) for 3D audio modeling.

![](Unity.png){fig-alt="Screenshot of the experimental plateform of SAM-Guide"}
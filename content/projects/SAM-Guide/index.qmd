...
image: logo.jpg
image-alt: "Logo illustrating the SAM-Guide project"
...
**1)** Before the project began, I put connected the consortium members together, organised meetings and wrote most of the grant proposal (ANR AAPG 2021, funding of 609k€)

**2)** Since then, I lead the design and development of the project's experimental platform (a series of automated testing environment in Unity)  

**3)** I also participated in the development of the second prototype of the vibro-tactile belt (which includes wireless communication and amovible vibrators)

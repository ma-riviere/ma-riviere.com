...
**2)** Handled the RT-qPCR data processing and analysis, as well as documenting and open-sourcing the resulting code.

**3)** Participated in writing the [journal article](/content/pubs/IP23/) summarizing the results of this project.

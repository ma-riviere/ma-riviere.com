...
website:
  open-graph:
    description: "Analyzing BNIP3 expression in the brain of an Alzheimer's disease rat model"
  twitter-card:
    description: "Analyzing BNIP3 expression in the brain of an Alzheimer's disease rat model"
...
**2)** Helped write the methodology/statistics part of the [paper](https://agalic-rd.com/content/pubs/articles/BM25/) [@rodriguez-dubocBnip3ExpressionBrain2025].

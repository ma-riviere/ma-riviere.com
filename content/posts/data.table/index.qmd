...
abstract: "This document is a collection of notes I took while learning to use data.table, summarizing the equivalences between most dplyr/tidyr verbs and their data.table equivalents."
...
## Subset/filter: subset by position/random -> slice_*

## dplyr::consecutive_id() (v1.1) vs data.table::rleid() : move from example to section
...
_Function to filter rows that have 2 or more non-zero decimals in one column_

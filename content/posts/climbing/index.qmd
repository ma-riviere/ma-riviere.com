...
abstract: |
  ...
  Several *translation* options for the data processing were included, such as `data.table`, `dtplyr`, or `dbplyr` with a `DuckDB` backend, with timings to compare their speed.

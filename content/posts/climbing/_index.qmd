...
:::{.callout-note}
This is simply a transposition of Ethan Rosenthal's [article on Bayesian Rock Climbing](https://www.ethanrosenthal.com/2022/04/15/bayesian-rock-climbing/) to R.

Stan code was updated to use [within-chain parallelization](https://mc-stan.org/docs/2_29/stan-users-guide/reduce-sum.html) and [compiler optimization](https://mc-stan.org/docs/2_29/stan-users-guide/optimization.html) for faster CPU sampling.
...
```{r}
#| echo: false
#| file: !expr c(here::here("src", "quarto", "style_ggplot_bi.R"), here::here("src", "quarto", "style_gt_mono.R"))
```

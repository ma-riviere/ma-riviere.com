...
tennis_mod_fit <- readRDS(archive_read(tennis_mod_path, format = "raw", filter = "zstd"))
```
...
saveRDS(tennis_mod_fit, file_write(tennis_mod_path, filter = "zstd", options = "compression-level=22"))
```

...
subtitle: | 
  ...
  and Human-Machine Interfaces<br>
  ![](res/img/flags/PF.png){width=25px style="margin-right: 5px"}
  ![](res/img/flags/FR.png){width=25px style="margin-right: 5px"}
  ![](res/img/flags/USA.png){width=25px height=17px style="margin-right: 5px"}
  ![](res/img/flags/NO.png){width=25px height=17px}
